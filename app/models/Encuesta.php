...
class Encuesta {
    ...
    public static function obtenerTodas() {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT puntuacionMesa, puntuacionRestaurante, puntuacionMozo, puntuacionCocinero, experiencia, descripcion FROM encuestas");
        $consulta->execute();
    ...
    public static function obtenerEncuesta($id) {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT puntuacionMesa, puntuacionRestaurante, puntuacionMozo, puntuacionCocinero, experiencia, descripcion FROM encuestas WHERE id = :id");
    ...
    public static function obtenerEncuestasPorFecha($fechaDesde, $fechaHasta) {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT puntuacionMesa, puntuacionRestaurante, puntuacionMozo, puntuacionCocinero, experiencia, descripcion FROM encuestas WHERE fecha BETWEEN :fechaDesde AND :fechaHasta");
